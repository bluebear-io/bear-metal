...
import { fetchRunThoughtTree, fetchTicketDetail, fetchTickets, fetchWorkers } from "./client.js";
...
export const useRunThoughtTree = (runId: string | null) =>
  useQuery({
    queryKey: ["thought-tree", runId],
    queryFn: () => fetchRunThoughtTree(runId!),
    enabled: runId !== null,
  });
