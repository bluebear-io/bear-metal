...
import { fetchTicketDetail, fetchTickets, fetchWorkers, fetchWorkersTimeline } from "./client.js";
...
export const useWorkersTimeline = (hours = 24) =>
  useQuery({ queryKey: ["workers", "timeline", hours], queryFn: () => fetchWorkersTimeline(hours) });
