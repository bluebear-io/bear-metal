...
describe("task customization", () => {
  ...
  it("maps PRs without provider-only fields and preserves timestamps", () => {
    const task = buildTask({ state: "iteration", iteration: 2, attachments: [], prs: [{ owner: "org", repo: "repo", number: 3 }], ticket: { issue: { id: "id", identifier: "DEN-1", title: "Title", description: null, url: "url", branchName: "branch", status: { name: "Started", type: "started" }, priority: 0, labels: [], teamKey: "DEN", assignee: null, delegate: null }, comments: [] }, pullRequests: [{ pullRequest: { title: "PR", html_url: "https://github/pr/3", state: "open", draft: false, merged: false, head: { ref: "branch" }, created_at: "created", updated_at: "updated", merged_at: null, closed_at: null }, headSha: "sha", failedCheckRuns: [], failedStatuses: [], unresolvedReviewThreads: [], reviewThreads: [], issueComments: [{ id: "comment", databaseId: 12, body: "body", author: "author", authorId: "provider-id", isMinimized: false, createdAt: "created", updatedAt: "updated" }], completedIssueComments: [], mergeable: true }] });
