...
const server = app.listen(config.port, () => {
  ...
  logger.info({ port: config.port, pid: process.pid }, "🚀 Bear Metal booted up — fueled by caffeine and conventional commits, let's go!");
});
...
function shutdown(signal: string): void {
  ...
  logger.info({ signal, pid: process.pid }, "🛌 Bear Metal clocking out — dreaming of green CI and clean diffs, catch you soon!");
