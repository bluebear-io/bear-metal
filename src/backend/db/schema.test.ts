...
describe("schema", () => {
  it("exports the full table set (six dashboard tables + ci_checks + review_threads)", () => {
    expect(Object.keys(schema).sort()).toEqual(
      ["ciChecks", "ciRuns", "events", "pullRequests", "reviewThreads", "runs", "tickets", "workers"].sort(),
    );
  });
