...
RUN apt-get update && apt-get install -y --no-install-recommends git ca-certificates curl unzip \
  && AWS_CLI_VERSION=2.36.41 \
  && AWS_CLI_SHA256_AMD64=659c1fe734a9534736fa452bb1b557dd4cccadea5823f45a74c0f09408a93d22 \
  && AWS_CLI_SHA256_ARM64=1612cda15d605985d8cb675ec429c8916e3b696fa52325994955dc3215c590a9 \
